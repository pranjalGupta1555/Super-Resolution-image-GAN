...
def test_model(input_hig_res, model, number_of_images, output_dir):
    ...
    x_test_lr = Utils.load_test_data_for_model(input_hig_res, 'jpg', number_of_images)
    #print (x_test_lr,x_test_hr,"hello")
    Utils.plot_test_generated_images_for_model(output_dir, model, x_test_lr)
...
if __name__== "__main__":
    ...
    parser.add_argument('-ihr', '--input_hig_res', action='store', dest='input_hig_res', default='C:/data_hr/' ,
                    help='Path for input images Hig resolution')

    parser.add_argument('-ilr', '--input_low_res', action='store', dest='input_low_res', default='C:/data_lr/' ,
                    help='Path for input images Low resolution')

    parser.add_argument('-o', '--output_dir', action='store', dest='output_dir', default='C:/output/' ,
                    help='Path for Output images')

    parser.add_argument('-m', '--model_dir', action='store', dest='model_dir', default='gen_model3000.h5' ,
                    help='Path for model')
